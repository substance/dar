...
**NOTE: This spec is a work in progress, and considered a request for comments. The current proposal reflects the [Stencila](https://github.com/stencila/stencila) Execution Model**.
