...
---|---
book|person-group[person-group-type=author]?, person-group[person-group-type=editor]?, person-group[person-group-type=translator]?, edition?, year?, month?, day?, title?, publisher-loc*, publisher-name*, page-count?, pub-id[pub-id-type='doi, pmid, isbn']?, volume?, series?
