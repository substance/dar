...
preprint|person-group[person-group-type=author]?, person-group[person-group-type=editor]?, year, month?, day?, article-title, source?, issue?, elocation-id?, comment?, pub-id[pub-id-type='doi, pmid']?
